...
;; Estudiante 2: Manuela Martínez Moncada - 2375458
;; Estudiante 3: Andrés Gerardo González Rosero - 2416541
;;====================================================
...
;; count-greater :
;; Proposito:
;; x L -> number : Cuenta cuántos elementos de la
...
;; palindrome? :
;; Proposito:
;; palabra -> Boolean : Determina recursivamente si una
